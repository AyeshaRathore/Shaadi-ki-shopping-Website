                            ...
                            <div class="row mb-50">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <?php
                                                $results=$productModel->readimagesbypro_id();
                                                $imagecount=0;
                                                if($results->num_rows>0){
                                                    while($rows = $results->fetch_assoc()){
                                                        $productModel->image=$rows['imageurl'];
                                                        echo ' <figure class="border-radius-10">
                                                        <img src="assets/imgs/shop/'.$productModel->image.'" alt="product image">
                                                    </figure>';
                                                    }
                                                }
                                            ?>
                                        ...
                                        <?php
                                                ...
                                                if($results->num_rows>0){
                                                    while($rows = $results->fetch_assoc()){
                                                        $productModel->image=$rows['imageurl'];
                                                        echo ' <div><img src="assets/imgs/shop/'.$productModel->image.'" alt="product image"></div>';
                                                    }
                                                }
                                            ?>
                                            <!-- <div><img src="assets/imgs/shop/thumbnail-3.jpg" alt="product image"></div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                    <?php
                                    $result=$productModel->readallbypro_id();
                                    if($result->num_rows>0){
                                        while($rows = $result->fetch_assoc()){
                                            ...
                                            if(isset($_SESSION['username'])){
                                                $cart = 'href="product-detail.php?cart='.$productModel->id.'';
                                                $favirate = 'href="product-detail.php?fav='.$productModel->id.'';
                                            }else{
                                                $favirate = 'href="login.php"';
                                                $cart = 'href="login.php"';
                                           }
                                            echo '<h2 class="title-detail">'.$productModel->title.'</h2>
                                       
                                            <div class="clearfix product-price-cover">
                                                <div class="product-price primary-color float-left">
                                                    <ins><span class="text-brand">'.$productModel->price.'</span></ins>
                                            ...
                                            <div class="detail-extralink">
                                                ...
                                                <div class="product-extra-link2">
                                                <a '.$cart.'" aria-label="Add To cart" class="action-btn hover-up" ><i class="fi-rs-shopping-bag-add"></i></a>
                                                    <a '.$favirate.'" aria-label="Add To Wishlist" class="action-btn hover-up" ><i class="fi-rs-heart"></i></a>
